...
- Known leftovers are **warnings**, capped by `--max-warnings` in `package.json` (currently 12, issue E11). When a fix removes warnings, lower the cap to the new count. Never raise it.
