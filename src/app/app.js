...
import { openBoard, selectBoardPin } from '../views/boards.view.js';
import { openDatasheet, selectDatasheetByComponent } from '../views/datasheet.view.js';
import { clearCompare, setFilter, sortComponents, toggleCompare } from '../views/library.view.js';
import { openProject } from '../views/projects.view.js';
import { openIn3D, selectComponent, selectPin, setViewMode } from '../views/viewer.view.js';
...
function init() {
  ...
  // The 3D engine starts the first time the Viewer opens (views/viewer.view.js, E18).
