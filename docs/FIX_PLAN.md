...
| Board Explorer | ✅ Styled layout (#16); pin clicks, highlighting and resizing work (#16b). 3 of the 7 tabs still show a stand-in board until their data is added (D24, #16c) |
...
| D18 | ⚪ | **AI replies show lists and tables as raw text.** The formatter only turns lines starting with "•" into a list, but the stored answers use "- " (43 lines, 0 list items). Tables (20 rows) show as raw `\|` pipes. Still readable. _Found in #13._ | [app.js:1752](../src/app/app.js#L1752) |
