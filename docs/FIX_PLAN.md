...
| Board Explorer | ✅ Styled layout (#16): the board beside the info panel, board tabs, pin filters, specs and a pin list. Behaviour bugs left: repeated click handlers, pin highlight, stand-in boards (D22–D24, #16b) |
